...
const generateEmailContent = (data)=>{
    ...
    return {
        ...
        <h2 style="text-align: center; color: rgb(54, 54, 172);">NEW MESSAGE FROM DMPS -  <span color="rgb(63, 239, 63)">ECO CLUB</span> </h2> <div class="form-container">${htmlData}</div></td></tr></table> </td></tr></table> </td></tr></table> </td></tr></table> </body></html>`
    };
};
...
var __webpack_exports__ = (__webpack_exec__(3799));
